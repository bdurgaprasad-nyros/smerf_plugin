class CreateSmerfs < ActiveRecord::Migration
  def self.up
    ...
    # Create link table between the questions and smerf_forms table 
    # which is used to record that the user completed and save the form
    create_table :questions_smerf_forms, :primary_key => :id, :force => true do |t|
  ...
  def self.down
    ...
    drop_table :questions_smerf_forms
